...
--
-- Host: 127.0.0.1    Database: basic_business_backend
-- ------------------------------------------------------
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`accountID`) REFERENCES `buyer` (`accountID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order` VALUES (1,1,'2026-01-01');
...
CREATE TABLE `payment` (
  ...
  KEY `accountID` (`accountID`),
  CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`accountID`) REFERENCES `buyer` (`accountID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
